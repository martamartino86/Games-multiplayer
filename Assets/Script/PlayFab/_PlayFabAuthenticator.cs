...
/// <summary>
/// (Tutorial) Classe di riferimento per login combinato Playfab + Photon
/// </summary>
public class _PlayFabAuthenticator : MonoBehaviour
{
    ...
    */
    private void RequestPhotonToken(LoginResult obj)
    {
        ...
        {
            // era PhotonNetwork.PhotonServerSettings.AppID ma penso fosse Photon 1
